...
public class ZeusException extends RuntimeException {
    ...
    public static final ZeusException FavoratedArticleError = new ZeusException("文章已收藏", 1173);
    public static final ZeusException InvalidArticleAddr = new ZeusException("无效的文章地址", 1174);
