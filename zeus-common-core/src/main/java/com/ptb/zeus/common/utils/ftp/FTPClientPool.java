...
public class FTPClientPool implements ObjectPool<FTPClient>{
    ...
    private static Logger log = Logger.getLogger(FTPClientPool.class);
    ...
    private void initPool(int maxPoolSize) throws Exception {
        for(int i=0;i<maxPoolSize;i++){
            ...
            if(null != client)
                ...
                log.error("initPool FTPClient: makeObject null");
        }
...
/*            try {
    ...
    */
    ...
    public void addObject(FTPClient client) throws Exception, IllegalStateException, UnsupportedOperationException {
        //插入对象到队列
