...
public class ConfigLoader {
	...
	// 配置文件路径
	private static String mailPath = "ptb.properties";
	// 邮件发送SMTP主机
	...
	static {
		...
		server = props.getProperty("zeus.server.mail.server");
		sender = props.getProperty("zeus.server.mail.sender");
		username = props.getProperty("zeus.server.mail.username");
		password = props.getProperty("zeus.server.mail.password");
		nickname = props.getProperty("zeus.server.mail.nickname");
