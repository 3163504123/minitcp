    ...
    <div class="easyui-accordion" data-options="multiple:true,selected:false,fit:true"
        ...
        <div title="百宝箱管理" style="overflow:auto;padding:10px;">
            <dl class="hx_admin_subnav">
                <dd>
                    <a href="#"
                       onclick='addclass(this);s.openSelf($("#center_tabs"), "API分类管理", "/toolSet")'>分类管理</a>
                </dd>
            </dl>
            <dl class="hx_admin_subnav">
                <dd>
                    <a href="#"
                       onclick='addclass(this);s.openSelf($("#center_tabs"), "API管理", "/tool")'>API管理</a>
                </dd>
            </dl>
        </div>
        ...
        <div title="系统管理" style="overflow:auto;padding:10px;">
            <dl class="hx_admin_subnav">
                <dd>
                    <a href="#"
                       onclick='addclass(this);s.openSelf($("#center_tabs"), "用户管理", "/u")'>用户管理</a>
                </dd>
            </dl>
        </div>
    </div>
