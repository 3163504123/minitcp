...
_293.pmask=$("<div class=\"window-mProxy-mask\"></div>").insertAfter(_293.window);
...
_293.proxy=$("<div class=\"window-mProxy\"></div>").insertAfter(_293.window);
...
var _3c1=$(">div.layout-split-mProxy-v",_3b9);
}else{
var _3c1=$(">div.layout-split-mProxy-h",_3b9);
}
...
if(dir=="north"||dir=="south"){
var _3c4=$(">div.layout-split-mProxy-v",_3b9);
_3c4.css("top",e.pageY-$(_3b9).offset().top-_3c4.height()/2);
}else{
var _3c4=$(">div.layout-split-mProxy-h",_3b9);
...
if(!_68f.proxy){
_68f.proxy=$("<div class=\"datagrid-resize-mProxy\"></div>").appendTo(dc.view);
}
